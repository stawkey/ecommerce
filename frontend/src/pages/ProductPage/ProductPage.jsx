    ...
    return (
        <div>
            ...
            <div className={style.productDetailsContainer}>
                ...
                <li><p><strong>Category:</strong> {product.category}</p></li>
                <li><p><strong>Description:</strong> {product.description}</p></li>
                <li><p><strong>Price:</strong> ${product.price.toFixed(2)}</p></li>
                <li>
